 ...
 * @e_ident: a pointer ELF magic number in a container.
...
/**
 * print_osabi - a function that print OS/OSABI of an ELF header.
 * @e_ident: pointer to an array containing the ELF version.
 */
 ...
 * @e_ident: gointer to an array containig the ELF ABI version..
 */
...
/**
 * print_entry - a function that prints entry point of an ELF header.
...
/**
 * main - a function that displays the information contained in
 * the ELF header at the start of and ELF file.
 * @argc: arguments supplied to the program.
 * @argv: array of pointers tot he arguments.
 * Return: 0 if success.
